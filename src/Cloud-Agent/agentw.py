#####################################################################################
# Cloud Agent W - Server Wireguard

# The code of this server is mainly a modified version of Alice's original code
# Can be found in /demo/runners/alice.py
...
#####################################################################################
# We try to extract all of the VCs from the wallet

            # extract VC from wallet 
            elif option == "5":
               cred = await alice_agent.admin_GET(
                   "/credential/w3c"
                )
